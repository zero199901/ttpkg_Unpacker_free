    ...
    K = z.defineStore("global-data", {
        ...
        actions: {
            ...
            updateSystemInfo: function(t) {
                ...
                this.systemInfo.appversion = e.appversion,
                F.api_update_system_info({
                    device_info: n
                })
            },
            ...
            getHeaderInfo: function() {
                ...
                e = {};
                e.totalHeight = t.top + t.height,
                e.leftGap = this.systemInfo.windowWidth - t.right,
                e.titleWidth = t.left - e.leftGap - t.width;
                var n = this.systemInfo.screenWidth / 375;
                e.threePointRight = t.width / 4 * 3 + e.leftGap - 22 * n,
                e.top = t.top,
                e.left = t.left,
                e.height = t.height,
                e.leftWidth = t.width,
