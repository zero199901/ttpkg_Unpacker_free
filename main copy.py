'''
Author: zym
Date: 2025-02-12 14:57:12
LastEditTime: 2025-02-12 14:57:14
LastEditors: zym
Description: 
FilePath: /ttpkgUnpacker-main/ttpkgUnpacker/main copy.py
'''
import binascii
    ...
    def load(io: FileIO):  # line:19
        ...
        if magic == MPK_MAGIC:  # line:22
            ...
            for i in range(count):  # line:30
                ...
                sys.exit()
                # name_length = 11
                file_data = IOHelper.read_struct(io, '<'+str(name_length)+'s')[0]  # line:35
